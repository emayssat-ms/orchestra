...
EC2_INSTANCE_ID?=$(firstword $(EC2_INSTANCE_IDS))
# EC2_INSTANCE_IDS?=
EC2_INSTANCE_IP?=$(firstword $(EC2_INSTANCE_IPS))
# EC2_INSTANCE_IPS?=
...
get_instance_ids_FVS=$(shell $(AWS) ec2 describe-instances --filters "Name=$(strip $(1)),Values=$(strip $(2))" "Name=instance-state-name,Values=running" --query 'sort_by(Reservations[].Instances[],$(3))[].InstanceId' --output text)
...
get_instance_metadata_FVSI=$(strip $(shell $(AWS) ec2 describe-instances --filters "Name=$(strip $(1)),Values=$(strip $(2))" "Name=instance-state-name,Values=running" --query "sort_by(Reservations[].Instances[],$(3))[$(4)]$(EC2_VIEW_INSTANCES_METADATA_FIELDS)" --output text))

#----------------------------------------------------------------------
# USAGE
#

_ec2_view_makefile_macros :: _ec2_instance_view_makefile_macros
_ec2_instance_view_makefile_macros ::
...
_ec2_view_makefile_targets :: _ec2_instance_view_makefile_targets
_ec2_instance_view_makefile_targets ::
	...
	@echo "    _ec2_view_instances_metadata            - Displays metadata on select EC2 instances"
	@echo

_ec2_view_makefile_variables :: _ec2_instance_view_makefile_variables
_ec2_instance_view_makefile_variables ::
	...
	@echo "    EC2_INSTANCE_IPS=$(EC2_INSTANCE_IPS)"
...
_ec2_remove_termination_protection:
	@$(INFO) "$(AWS_LABEL)Removing termination protection for selected instances ..."; $(NORMAL)
	@$(WARN) "Instance IDS: $(EC2_INSTANCE_IDS)"; $(NORMAL)
...
_ec2_terminate_instances:
	@$(INFO) "$(AWS_LABEL)Terminating selected instances ..."; $(NORMAL)
	@$(WARN) "Instance IDS: $(EC2_INSTANCE_IDS)"; $(NORMAL)
...
_ec2_view_instances_metadata:
	@$(INFO) "$(AWS_LABEL)Displaying select instances ..."; $(NORMAL)
